...
export default function Home() {
  return (
    <div>
      <Head>
        <title>Titan Air Blowers | menu</title>
        <meta name="description" content="Titan Air Blowers | menu" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <Header />
      <main>
        <div className='w-full bg-no-repeat bg-cover bg-center flex items-end page_hero page_menu'>
          <div className='container mx-auto px-6 page_title uppercase mb-5'>Menu</div>
        </div>
        <Advantages />
