  ...
  return (
    <Fragment>
      ...
      <div className='flex items-center mb-2.5'>
        <Image src="/images/icon/address.svg" alt="" width={16} height={22} className='mr-2' style={{width: "auto", height: "auto"}} />
      ...
      <div className='flex items-center mb-2.5'>
        <Image src="/images/icon/phone.svg" alt="" width={17} height={17} className='mr-2' style={{width: "auto", height: "auto"}} />
        <a href="tel:+91 9033318899">+91 9033318899</a>&nbsp;&nbsp;<a href="tel:+91 8866822252">+91 8866822252</a>
      </div>
      <div className='flex items-center mb-2.5'>
        <Image src="/images/icon/email.svg" alt="" width={18.85} height={13.25} className='mr-2' style={{width: "auto", height: "auto"}} />
